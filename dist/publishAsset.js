...
export async function publishAsset(aquarius, params, signer, config) {
    try {
        ...
        // Other networks
        const did = await createAssetUtil(params.title, 'OCEAN-NFT', signer, assetUrl, metadata, params.providerUrl, config, aquarius);
        ...
        await updateAssetMetadata(signer, metadata, params.providerUrl, aquarius);
...
//# sourceMappingURL=publishAsset.js.map